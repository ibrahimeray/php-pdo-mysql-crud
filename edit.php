...
<div class="container-pages">
    ...
    <div class="container-fluid">
		<div class="row">
            <div class="col-lg-12">
				<div class="error"><center><?php if (isset($error)) {
	echo $error;
} ?></center></div>
            </div>
        </div>
			...
			<div class="col-lg-8"> 
                <form class="form-horizontal" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="titel" name="titel" placeholder="Titel eingeben" value="<?= $jobdetails['titel'] ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="beschreibung">Text:</label>
                        <div class="col-sm-10"> 
                            <textarea id="beschreibung" class="mceEditor" name="beschreibung" rows="15" required><?= $jobdetails['beschreibung'] ?></textarea>
                        </div>
                    </div>

                    <div class="form-group"> 
                        <div class="col-sm-offset-2 col-sm-10 text-right bold">
							<button type="submit" class="btn-link btn-img speichern bold" name="edit_save">Speichern</button>
